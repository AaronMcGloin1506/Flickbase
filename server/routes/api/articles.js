...
.post(checkedLoggedIn, grantAccess('createAny','article'), async(req,res)=>{
    try{
...
.get(checkedLoggedIn, grantAccess('readAny','article'),async(req,res)=>{
    try{
...
.patch(checkedLoggedIn, grantAccess('updateAny','article'),async(req,res)=>{
    try{
        const _id = req.params.id;
...
.delete(checkedLoggedIn, grantAccess('deleteAny','article'),async(req,res)=>{
    try{
        const _id = req.params.id;
...
.post(checkedLoggedIn, grantAccess('readAny','articles'),async(req,res)=>{
    try{
